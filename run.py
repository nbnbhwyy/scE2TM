...
def main():
    ...
    runner = Runner(args)
    beta = runner.train(dataset_handler.train_loader, dataset_handler.test_loader, dataset_handler.vocab, num_top_word=args.num_top_word, test_label = dataset_handler.test_labels)   
